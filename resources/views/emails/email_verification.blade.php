...
<html lang="en">
  <head>
    ...
    <title>Sellhub Email Verification</title>
    <style type="text/css">
  ...
  <body class="o_body o_bg-white" style="width: 100%;margin: 0px;padding: 0px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #ffffff;">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
      <tbody>
        <tr>
          <td class="o_hide" align="center" style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
            Email Verification
          </td>
        </tr>
      </tbody>
      ...
      <tbody>
        <tr>
          <td class="o_bg-dark o_px-md o_py-md o_sans o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #242b3d;padding-left: 24px;padding-right: 24px;padding-top: 24px;padding-bottom: 24px;">
            <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-white" href="https://sellhub.io/" style="text-decoration: none;outline: none;color: #ffffff;">
              <img src="{{ asset('email/images/logo.png') }}" width="200" height="60" alt="Sellhub" style="-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a></p>
          </td>
        </tr>
      </tbody>
    </table>
        ...
        <tr>
          <td class="o_bg-dark o_px-md o_py-xl o_xs-py-md" align="center" style="background-color: #242b3d;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
            ...
            <div class="o_col-6s o_sans o_text-md o_text-white o_center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;max-width: 584px;color: #ffffff;text-align: center;">
              <h2 class="o_heading o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;font-size: 30px;line-height: 39px;">Email Verification</h2>
              <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">To complete your email verification, please enter the following One-Time Password (OTP):</p>
              <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                <tbody>
                  <tr>
                    <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #405ccc;border-radius: 4px;">
                        <a class="o_text-white" href="#!" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">
                            {{ $otp }}
                        </a>
                    </td>
                  </tr>
        ...
        <tr>
          <td class="o_bg-dark o_px-md o_py-lg" align="center" style="background-color: #242b3d;padding-left: 24px;padding-right: 24px;padding-top: 32px;padding-bottom: 32px;">
            ...
            <div class="o_col-6s o_sans o_text-xs o_text-dark_light" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;max-width: 584px;color: #a0a3ab;">
              <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><a class="o_text-dark_light" href="https://sellhub.io" style="text-decoration: none;outline: none;color: #a0a3ab;">
                <img src="{{ asset('email/images/favico.png') }}" width="30" height="30" alt="Sellhub" style="max-width: 36px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a></p>
              <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">{{ date('Y') }} Sellhub Portal</p>
            
              <p style="margin-top: 0px;margin-bottom: 0px;">
                <a class="o_text-dark_light o_underline" href="https://sellhub.io/contact" style="text-decoration: underline;outline: none;color: #a0a3ab;">Contact Center</a> <span class="o_hide-xs">&nbsp; • &nbsp;</span><br class="o_hide-lg" style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
