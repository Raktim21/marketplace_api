            ...
            <tr>
                <td class="o_bg-dark o_px-md o_py-xl o_xs-py-md" align="center"
                    ...
                    <div class="o_col-6s o_sans o_text-md o_text-white o_center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;max-width: 584px;color: #ffffff;text-align: center;">
                        <h2 class="o_heading o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;font-size: 30px;line-height: 39px; color: #3de06e;">
                            A Product Has Been Restocked
                        </h2>
                        <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                            A product variant has been restocked and is now available for purchase.
                        </p>
                            ...
                            <tbody>
                                <tr>
                                    <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #405ccc;border-radius: 4px;">
                                        <a class="o_text-white" href="{{ $url }}" target="_blank" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">
                                            {{ $title }}
                                        </a>
                                    </td>
                                </tr>
